...
const handleTabsEdit = (targetName: string | number, action: 'remove' | 'add') => {
...
<template>
                  ...
                  <div class="tab-content">
                    <div class="left">
                      <el-tabs :tab-position="'left'" v-model="selectTabIndexObj[selectTabIndex]">
                        <el-tab-pane
                          :label="item1"
                          v-for="(item1, index1) in Object.keys(item)"
                          :key="index1"
                          :name="item1"
                        ></el-tab-pane>
                      </el-tabs>
                      ...
                      <template v-if="selectTabIndexObj[selectTabIndex] === 'resource'">
                        <el-row :gutter="24">
                          <el-col :span="8">
                            <el-form-item
                              label="匹配规则"
                              :prop="`location[${index}][${selectTabIndexObj[selectTabIndex]}].matching`"
                              :rules="rules.matching"
                            >
                              <el-input
                                v-model="item[selectTabIndexObj[selectTabIndex]].matching"
                                placeholder="请输入内容"
                              ></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :span="8">
                            <el-form-item label="proxy_pass">
                              <el-input
                                v-model="item[selectTabIndexObj[selectTabIndex]].proxy_pass"
                                placeholder="请输入内容"
                              ></el-input>
                            </el-form-item>
                          </el-col>
                          <el-col :span="8">
                            <el-form-item label="rewrite">
                              <el-input
                                v-model="item[selectTabIndexObj[selectTabIndex]].rewrite"
                                placeholder="请输入内容"
                              ></el-input>
                            </el-form-item>
                          </el-col>
                        ...
                        <el-row :gutter="24">
                          <el-col :span="8">
                            <el-form-item label="位置">
                              <el-input
                                v-model="item[selectTabIndexObj[selectTabIndex]].position"
                                placeholder="请输入内容"
                              ></el-input>
                            </el-form-item>
                          </el-col>
  ...
  <yaml-editor
    :init-data="initData"
    v-model:visible="isShowYamlEditor"
    @setValue="setValue"
  ></yaml-editor>
</template>
