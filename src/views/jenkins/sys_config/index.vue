  ...
  <div class="main-wrapp">
    ...
    <el-form class="form-wrap" :model="queryParams" ref="queryFormRef" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-row :gutter="20">
        ...
        <el-col :span="8">
          <el-form-item label="工具名称" prop="groupName">
            <el-input
    ...
    <div class="table-wrap">
      <el-table v-loading="loading" :data="sysConfigPageList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="工具编号" align="center" key="id" prop="id"/>
          <el-table-column label="工具名称" align="center" key="gitlabGroupName" prop="gitlabGroupName"  :show-overflow-tooltip="true"  width="100" />
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="工具名称" prop="groupName">
              <el-input v-model="form.groupName" placeholder="请输入工具名称" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="权限" prop="visibility">
