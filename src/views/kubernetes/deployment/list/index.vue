<script setup lang="ts">
  ...
  const handleAdd = function(){
    router.push({path : "/kubernetes/deployment/index", query:{ instanceCode: defaultInstanceCode.value } })
  }

  const handleUpdate = function(id){
    router.push({path : "/kubernetes/deployment/index", query:{ instanceCode: defaultInstanceCode.value ,id: id} })
  }
