<script setup lang="ts">
  ...
  const handleDetail = function(row){
    router.push({path : "/kubernetes/pod/operate", query:{ instanceCode: defaultInstanceCode.value ,id: row.id} })
  }
  ...
  const btnList = ref([
    {
      btnName: '查看',
      permArray: ['/kubernetes/pod/detail/*'],
      isShow: () => true,
      isDisable: false,
    ...
    },
    {
      ...
      permArray: ['/kubernetes/pod/changeStatus/**'],
      isShow: () => true,
      isDisable: false,
