<script setup lang="ts">
  ...
  import { pageList,nameSpaceList,removeService,changeStatus} from "@/api/kubernetes/service"
  ...
  const handleAdd = function(){
    router.push({path : "/kubernetes/service/operate", query:{ instanceCode: defaultInstanceCode.value } })
  }

  const handleDetail = function(row){
    router.push({path : "/kubernetes/service/operate", query:{ instanceCode: defaultInstanceCode.value ,id: row.id} })
  }
  ...
  const handleSelectionChange = function(selection){
   ...
   const btnList = ref([
    {
      btnName: '查看',
      permArray: ['/kubernetes/service/detail/*'],
      isShow: () => true,
      isDisable: false,
    ...
    },
    {
      ...
      permArray: ['/kubernetes/service/changeStatus/**'],
      isShow: () => true,
      isDisable: false,
    ...
    {
      btnName: '删除',
      permArray: ['/kubernetes/service/del/**'],
      isShow: () => true,
      isDisable: false,
    ...
    <yt-card>
        <div class="option-wrap">
          <el-button
            ...
            plain
            size="default"
            @click="handleAdd" v-hasPerms="['/kubernetes/service/add']" ><el-icon><Plus /></el-icon>新增</el-button>
        </div>
      <!--table  -->
            ...
            <!-- <template #default="scope">
              <div class="action-btn">
                <el-button
                  ...
                  v-hasPerms="['/kubernetes/service/detail/*']"
                >查看</el-button>
                <el-button
                  size="small"
                  :icon="getStatusIcon(scope.row)"
                  @click="handleStatusChange(scope.row)"
                  v-hasPerms="['/kubernetes/service/changeStatus/**']"
                >{{ showStatusOperateFun(scope.row.status)  }}</el-button>
                <el-button
                  size="small"
                  icon="Delete"
                  @click="handleDelete(scope.row)"
                  v-hasPerms="['/kubernetes/service/del/**']"
                >删除</el-button>
              </div>
            </template> -->
